...
implements ActionListener {
    //HashMap is used to map the button to the method that it will call
    ...
    //setPreferredSize is used to set the size of the frame
    protected void setPreferredSize(int width, int height) {
        this.frame.setPreferredSize(new Dimension(width, height));
    }
    // setMinimumSize is used to set the minimum size of the frame
    protected void setMinimumSize(int width, int height) {
        this.frame.setMinimumSize(new Dimension(width, height));
    }
    // setMaximumSize is used to set the maximum size of the frame
    protected void setMaximumSize(int width, int height) {
        this.frame.setMaximumSize(new Dimension(width, height));
    }
    // getWidth is used to get the width of the frame
    public int getWidth() {
        return this.frame.getWidth();
    }
    // getHeight is used to get the height of the frame
    public int getHeight() {
        return this.frame.getHeight();
    }

    // addMenuButton is used to add a menu button to the menu bar.
    ...
    // addMenuRadioButton is used to add a radio button to the menu bar.
    ...
    // addSeparator is used to add a separator to the menu bar.
    ...
    // isSelected is used to check if a radio button is selected.
    ...
    // addButton is used to add a button to the frame.
